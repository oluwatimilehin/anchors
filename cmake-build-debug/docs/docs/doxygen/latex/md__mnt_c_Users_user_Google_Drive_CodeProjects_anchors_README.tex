...
It allows you model complex computations as a DAG which will update efficiently in response to an input change.\hypertarget{md__mnt_c_Users_user_Google_Drive_CodeProjects_anchors_README_autotoc_md1}{}\doxysection{Usage}\label{md__mnt_c_Users_user_Google_Drive_CodeProjects_anchors_README_autotoc_md1}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{ \{c++\}}
\DoxyCodeLine{using namespace anchors;}
\DoxyCodeLine{}
\DoxyCodeLine{Engine d\_engine; // First set up the anchors engine}
\DoxyCodeLine{}
\DoxyCodeLine{AnchorPtr<int> anchorA(Anchors::create(2));}
\DoxyCodeLine{AnchorPtr<int> anchorB(Anchors::create(3));}
\DoxyCodeLine{}
\DoxyCodeLine{auto sum = [](int a, int b) \{ return a + b; \};}
\DoxyCodeLine{}
\DoxyCodeLine{auto anchorC(Anchors::map2<int>(anchorA, anchorB, sum)); // Note that the function will not be called until you `get` the value of `anchorC`.}
...
\end{DoxyCode}
\hypertarget{md__mnt_c_Users_user_Google_Drive_CodeProjects_anchors_README_autotoc_md2}{}\doxysubsection{More Examples}\label{md__mnt_c_Users_user_Google_Drive_CodeProjects_anchors_README_autotoc_md2}
\hypertarget{md__mnt_c_Users_user_Google_Drive_CodeProjects_anchors_README_autotoc_md3}{}\doxysubsection{String Concatenation}\label{md__mnt_c_Users_user_Google_Drive_CodeProjects_anchors_README_autotoc_md3}
...
\end{DoxyCode}
\hypertarget{md__mnt_c_Users_user_Google_Drive_CodeProjects_anchors_README_autotoc_md4}{}\doxysubsubsection{Using an Input of a Different Type}\label{md__mnt_c_Users_user_Google_Drive_CodeProjects_anchors_README_autotoc_md4}
...
\end{DoxyCode}
\hypertarget{md__mnt_c_Users_user_Google_Drive_CodeProjects_anchors_README_autotoc_md5}{}\doxysubsubsection{Verifying That It Avoids Needless Computations}\label{md__mnt_c_Users_user_Google_Drive_CodeProjects_anchors_README_autotoc_md5}
...
\end{DoxyCode}
\hypertarget{md__mnt_c_Users_user_Google_Drive_CodeProjects_anchors_README_autotoc_md6}{}\doxysubsection{Note}\label{md__mnt_c_Users_user_Google_Drive_CodeProjects_anchors_README_autotoc_md6}
...
\end{DoxyItemize}\hypertarget{md__mnt_c_Users_user_Google_Drive_CodeProjects_anchors_README_autotoc_md7}{}\doxysection{Installation}\label{md__mnt_c_Users_user_Google_Drive_CodeProjects_anchors_README_autotoc_md7}
\hypertarget{md__mnt_c_Users_user_Google_Drive_CodeProjects_anchors_README_autotoc_md8}{}\doxysection{Roadmap}\label{md__mnt_c_Users_user_Google_Drive_CodeProjects_anchors_README_autotoc_md8}
